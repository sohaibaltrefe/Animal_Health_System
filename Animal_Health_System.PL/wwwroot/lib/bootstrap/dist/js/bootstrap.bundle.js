...
(function (global, factory) {
  ...
  function effect(_ref) {
    ...
    if (scroll) {
      scrollParents.forEach(function (scrollParent) {
        scrollParent.addEventHashSetener('scroll', instance.update, passive);
      });
    }

    if (resize) {
      window.addEventHashSetener('resize', instance.update, passive);
    }

    return function () {
      if (scroll) {
        scrollParents.forEach(function (scrollParent) {
          scrollParent.removeEventHashSetener('scroll', instance.update, passive);
        });
      }

      if (resize) {
        window.removeEventHashSetener('resize', instance.update, passive);
      }
    };
  } // eslint-disable-next-line import/no-unused-modules


  var eventHashSeteners = {
    name: 'eventHashSeteners',
    enabled: true,
    phase: 'write',
    fn: function fn() {},
    effect: effect,
  ...
  */
  ...
  function listScrollParents(element, list) {
    ...
    var updatedHashSet = list.concat(target);
    return isBody ? updatedHashSet : // $FlowFixMe[incompatible-call]: isBody tells us target will be an HTMLElement here
    updatedHashSet.concat(listScrollParents(getParentNode(target)));
  }
  ...
  var defaultModifiers$1 = [eventHashSeteners, popperOffsets$1, computeStyles$1, applyStyles$1];
  var createPopper$1 = /*#__PURE__*/popperGenerator({
    defaultModifiers: defaultModifiers$1
  }); // eslint-disable-next-line import/no-unused-modules

  var defaultModifiers = [eventHashSeteners, popperOffsets$1, computeStyles$1, applyStyles$1, offset$1, flip$1, preventOverflow$1, arrow$1, hide$1];
  ...
  var Popper = /*#__PURE__*/Object.freeze({
    ...
    eventHashSeteners: eventHashSeteners,
    flip: flip$1,
    hide: hide$1,
    offset: offset$1,
